...
<head>
    ...
    <title><?= $property['property_name']; ?> | Student Accommodation</title>
...
interested
        ...
        <div class="row no-gutters">
            ...
            <div class="button-container col-6">
                <a href="#" class="btn btn-primary">Reserve Accommodation</a>
            </div>
        </div>
    </div>
    ...
    <div class="property-about page-container">
        <h1>About this Accommodation</h1>
        <p><?= $property['description'] ?></p>
    </div>

    <div class="property-about page-container">

    <h1>Student Accommodation Details</h1>

    <div class="row">

        <div class="col-md-4">
            <h5>🏫 Nearby University</h5>
            <p><?= $property['university_name']; ?></p>
        </div>

        <div class="col-md-4">
            <h5>📍 Distance from University</h5>
            <p><?= $property['university_distance']; ?></p>
        </div>
        ...
        <div class="col-md-4">
            ...
            <p>₹ <?= number_format($property['deposit']); ?></p>
        </div>
